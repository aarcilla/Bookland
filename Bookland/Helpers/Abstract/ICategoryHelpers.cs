...
namespace Bookland.Helpers.Abstract
{
    public interface ICategoryHelpers
    {
        ...
        /// <returns>A SelectListItem enumeration of all stored categories, with tree-like formatting.</returns>
        IEnumerable<SelectListItem> ParentCategoryOptions(TreeNode<Category> categoryTree, int selectedCategoryID, params Category[] excludedCategories);
    }
}
